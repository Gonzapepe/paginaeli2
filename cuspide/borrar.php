<!DOCTYPE html>
	...
	<body>
		<h1> <img src="img/cuspide.jpg" /> <a href="index.php" title="Volver al Inicio"><img src="img/volver.png" /></a></h1>
		  <main>
		    <form class="form2" action="borrar.php" method="post">
		      <p>Ingrese ISBN a Borrar: <input type="number" name="isbn" /><button type="submit" name="buscar">Buscar</button></p>
		    </form>	
			...
			<?php
			  if(isset($_POST["buscar"])) //si se presionó el botón submit
			  {
				...
				{	
			      ...
			      echo "</table>";
			      echo "<p class='p'><a href='borrar2.php?isbn=$isbn'>BORRAR LIBRO</a></p>";
			 }//del encontrado  
			...
			<script>
			  ...
			  {
				  var res=confirm("Confirma eliminación del ISBN "+ISBN +"?");
				  if (res==true)
					  window.location="borrar2.php?isbn=isbn";
